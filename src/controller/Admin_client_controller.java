 ...
 */
public class Admin_client_controller implements Initializable
{
  ...
  @FXML
  protected void handle_add_client_action(ActionEvent event)
  {

  }

  @FXML
  protected void handle_edit_client_action(ActionEvent event)
  {
