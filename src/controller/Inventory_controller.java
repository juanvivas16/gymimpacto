...
public class Inventory_controller implements Initializable
{
  ...
  @FXML
  protected void handle_delete_activity(ActionEvent event)
  {

  }
  
  @FXML
  protected void handle_edit_inventory_activity(ActionEvent event)
  {

  }

  @FXML
  protected void handle_add_inventory_action(ActionEvent event) throws IOException
  {
    FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/ui/add_inventory_ui.fxml"));
  
    Parent root = fxmlLoader.load();
    Inventory_add_controller controller = fxmlLoader.<Inventory_add_controller>getController();
  ...
  @FXML
  protected void handle_back_activity(ActionEvent event) throws IOException
  {
