 ...
 */
public class Manager_income_controller implements Initializable
{
  ...
  @FXML
  protected void handle_exit_activity(ActionEvent event) throws IOException
  {
  ...
  @FXML
  protected void handle_view_income_activity(ActionEvent event)
  {
